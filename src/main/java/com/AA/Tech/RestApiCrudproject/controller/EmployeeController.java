package com.AA.Tech.RestApiCrudproject.controller;
...
import com.AA.Tech.RestApiCrudproject.service.EmployeeServiceI;
...
public class EmployeeController {
	...
	@PostMapping(value = "/saveEmployee", consumes = { "application/xml", "application/json" }, produces = {
	...
	@PostMapping(value="/getEmployeeIdRequestBody",consumes="application/json",produces = {"application/json"})
